...
namespace CKGL
{
	...
	public struct Colour
	{
		...
		public static readonly Colour Fuchsia = 0xFF00FFFF;
		...
		public static class XNA
		{
			...
			public static Colour DarkSlateGray = new Colour(0xff4f4f2f);
			...
			public static Colour LightSlateGray = new Colour(0xff998877);
			...
			public static Colour SlateGray = new Colour(0xff908070);
