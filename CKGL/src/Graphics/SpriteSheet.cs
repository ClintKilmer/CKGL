...
//#if DEBUG
//			Point2 offset = GetValidPlacementNaive(source.Width, source.Height);
//#else
//			Point2 offset = GetValidPlacement(source.Width, source.Height);
//#endif
...
//			Sprite sprite = new Sprite(this, offset.X, offset.Y, source.Width, source.Height);
//			Sprites.Add(sprite);
...
//			int spriteOffsetX = 0;
//			int spriteWidth = source.Width;

//			if (xtrim)
//			{
//				spriteOffsetX = source.Width;
//				spriteWidth = 0;
...
//#if DEBUG
//			Point2 offset = GetValidPlacementNaive(spriteWidth, source.Height);
//#else
...
//			Sprite sprite = new Sprite(this, offset.X, offset.Y, spriteWidth, source.Height);
//			Sprites.Add(sprite);
//			aabbs.Add(new AABBi(sprite.X, sprite.Y, sprite.Width, sprite.Height));
//			return sprite;
//		}
