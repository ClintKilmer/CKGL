...
namespace NormalMapping
{
	...
	public static class Shaders
	{
		...
		public static NormalTangentBitangentShader NormalTangentBitangentShader = new NormalTangentBitangentShader();
	}
...
void main()
{
	...
	public class NormalMapping : Game
	{
		...
		{
			Engine.Init(windowTitle: "CKGL Example - Normal Mapping",
		...
		public struct Vertex
		{
			...
			public Vertex(Vector3 position, Vector3 normal, Colour colour, UV uv, bool textured, Vector3 tangent, Vector3 bitangent)
			{
				Position = position;
				Normal = normal;
				Colour = colour;
		...
		public override void Init()
		{
			...
			vertexFormat = new VertexFormat(
				...
				new VertexAttribute(DataType.Float, 3, false),        // Tangent
				new VertexAttribute(DataType.Float, 3, false)         // Bitangent
			);
			...
			for (int i = 0; i < icosphereGeometry.Vertices.Length; i++)
				icosphereVertices[i] = new Vertex(icosphereGeometry.Vertices[i].Position, icosphereGeometry.Vertices[i].Normal, icosphereGeometry.Vertices[i].Colour, icosphereGeometry.Vertices[i].UV, false, icosphereGeometry.Vertices[i].Tangent, icosphereGeometry.Vertices[i].Bitangent);
